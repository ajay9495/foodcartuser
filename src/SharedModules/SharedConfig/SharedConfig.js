...
export default function useSharedConfig(){
    ...
    const LOCAL_BASE_URL = 'http://localhost/projects/api/public/api/';
    const REMOTE_BASE_URL = 'https://homeshope.xyz/public/api/';
    const REMOTE_BASE_URL_TWO = 'http://139.59.93.2/public/api/';

    const LOCAL_CATEGORY_IMAGE_BASE = "http://localhost/projects/api/storage/app/public/categories/";
    ...
    const LOCAL_PRODUCT_IMAGE_BASE = "http://localhost/projects/api/storage/app/public/products/";
